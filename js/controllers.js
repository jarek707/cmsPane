            ...
            return {
                'injectRelChild' : function($scope) {
                   // var relEl = angular.element($scope.meta.relContainer);
                    ...
                    angular.element($scope.meta.relContainer).replaceWith($compile( 
                        "<cms-pane"
                        + " key='" + meta.key + "'"
                        + " rel='" + meta.rel + "'"
                        + " rel-key='" + meta.relKey + "'"
                        ...
                        + " parent-list='list'" 
                        + " meta='" + encodeURIComponent(JSON.stringify(meta)) + "'></cms-pane>"
                    )($scope));
                },
                ...
                'set' : function(type, $scope, $element) {
                    ...
                    if (!_.isUndefined($scope.meta.rel) && _.isFunction(this[type][$scope.meta.rel])) {
                        this[type][$scope.meta.rel]($scope, $element);
                    }
                },
                'head' :  {
                ...
                'main' : {
                    ...
                    'm-1'  :function($scope) {
                        ...
                        $scope.updateRelData = function(data) {
                    ...
                    'm-1-m'  :function($scope) {
                        ...
                        $scope.$on('relDataChanged', function(evt) {
                            $scope.updateList();
                        });
